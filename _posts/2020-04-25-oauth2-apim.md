...
4. In the Settings tab of the Todo API, enter the Web Service URL (our backend Todo API), and disable subscribtion requirement (we are doing a demo)
...
```json
{
  ...
  "TodoList": {
    ...
    */
    ...
    "TodoListBaseAddress": "https://tosokr-todo-api.azurewebsites.net" //or {your_todo_api}
